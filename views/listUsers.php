<h2><span class="dashicons dashicons-businessman" style="margin-top: 5px;"></span> Usuarios Guardados</h2>
		<table>
			<tr>
				<td>
					Selecciona un formulario para desplegar resultados
				</td>
				<td>
					<form name="" method="get" action="">
						<input type="hidden" name="page" value="rabud_setup">
						<select name="formTest" onchange="this.form.submit()">
